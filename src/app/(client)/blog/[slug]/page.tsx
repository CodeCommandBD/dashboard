...
import { getBlogCategories, getOthersBlog, getSingleBlog } from "@/sanity/quaries";
...
const SingleBlogPage = async ({
  ...
  const blogs = await getSingleBlog(slug);
  const blog: SINGLE_BLOG_QUERYResult = Array.isArray(blogs) ? blogs[0] : blogs;
