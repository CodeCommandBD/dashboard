...
import AddToCart from "@/components/PriceView/AddToCart";
import Price from "@/components/PriceView/Price";
import ProductCharacteristics from "@/components/ProductCharacterist/ProductCharacteristics";
    ...
    <Container className="flex flex-col md:flex-row gap-10 py-10">
      ...
      <div className="w-full md:w-1/2 flex flex-col gap-5">
        ...
        <div className="flex flex-wrap items-center justify-between gap-2.5 border-b border-b-gray-200 py-5 -mt-2">
          <div className="flex items-center gap-2 text-sm text-black hover:text-red-600 transition-all duration-300">
